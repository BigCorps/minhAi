...
const ESPECIALISTAS = [
  ...
  { nome: 'Orçamentos',  tagline: 'Orçamento completo em segundos', color: '#3b82f6', Icon: FileText },
  ...
  { nome: 'Antifraude',  tagline: 'Detecta fraudes em segundos',    color: '#f59e0b', Icon: ShieldAlert },
