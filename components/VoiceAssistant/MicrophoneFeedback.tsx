...
/**
 * Componente: MicrophoneFeedback
 * 
 * Exibe um ícone de microfone com feedback visual de estado:
 * - Roxo/Violeta: Wake word detectada (pronto para ouvir comando)
 * - Azul: Escutando normalmente
 * - Verde: Processando
 * - Vermelho: Erro
 * 
 * Muda de cor instantaneamente quando a wake word é detectada,
 * similar ao comportamento da Alexa.
 */
...
export function MicrophoneFeedback({
  ...
  if (isWakeWordDetected) {
    // Roxo/Violeta quando wake word é detectada
    bgColor = 'bg-purple-600';
    iconColor = 'text-white';
    glowColor = 'rgba(147, 51, 234, 0.5)';
    pulseAnimation = 'animate-pulse';
  } else if (isProcessing) {
    // Verde quando processando
    bgColor = 'bg-emerald-600';
    iconColor = 'text-white';
    glowColor = 'rgba(16, 185, 129, 0.5)';
    pulseAnimation = 'animate-pulse';
  } else if (isListening) {
    // Azul quando escutando
    bgColor = 'bg-blue-600';
    iconColor = 'text-white';
  ...
  // Calcular tamanho com base no volume
