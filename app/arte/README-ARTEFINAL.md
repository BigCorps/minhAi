...
- **Grátis para começar:** cadastro dá **20 créditos**, sem cartão
  (trigger `on_user_created → initialize_user_credits`, por `user_id`). **Não existe trial temporal no ArteFinal.**
