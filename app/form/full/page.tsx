...
export default function FormularioFullPage() {
  ...
  if (status === 'sucesso') {
    return (
     <div
       className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 px-4"
       style={{ colorScheme: 'light', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
     >
  ...
  return (
   <div
     className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 py-10 px-4"
