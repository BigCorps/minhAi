...
const VANTAGENS = [
  {
    ...
    description: 'WebApp com sua marca — sem publicar na Play Store ou App Store. Funciona como app nativo, com seu logo, nome e dominio a sua escolha. Consulte tambem sobre White Label.',
    color: 'blue' as const,
  },
  {
    icon: (
