...
import { DashboardHeader } from '@/components/layout/DashboardHeader'; // Ajuste o caminho conforme necessário
import { useTheme } from '@/contexts/ThemeContext';

interface EmpresasClientProps {
  companies: any[];
  user: any; // Adicionado para passar ao Header
}

export default function EmpresasClient({ companies, user }: EmpresasClientProps) {
  // Agora usamos o contexto global de tema, e não um estado local
  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Cabeçalho Interno (Título e Botão Nova Empresa) */}
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center space-x-4">
             {/* Botão Voltar removido pois já temos o menu, mas se quiser manter: */}
             {/* <Link ... Voltar ... /> */}
            
            <Link
              href="/dashboard/empresas/nova"
              className="px-4 py-2 bg-primary-green text-white rounded-lg hover:bg-primary-green-dark transition font-semibold flex items-center shadow-lg shadow-green-900/20"
            >
        ...
        {/* Lista de Empresas ou Empty State */}
