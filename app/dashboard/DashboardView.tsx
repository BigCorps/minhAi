    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 transition-colors">
        ...
        <>
          ...
          <div className="fixed top-0 left-0 bottom-0 w-64 bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-white/10 z-50 p-6">
            <div className="flex items-center justify-between mb-8">
              ...
              <button onClick={() => setSidebarOpen(false)} className="p-2 rounded-lg text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-white/5">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Olá, {displayName}! 👋</h1>
          ...
          <div className="bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 rounded-xl p-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-green-700 dark:text-green-400">✅ Dashboard com theme toggle funcionando!</span>
            </div>
          </div>
        </div>
      </main>
