...
// ============================================================
// components/cliente/dashboards/ColaboradorDashboard.tsx
...
import { Zap, Tag, PhoneCall } from 'lucide-react';
...
export default function ColaboradorDashboard({ profile, company, theme }: Props) {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-base" style={{ color: muteColor }}>
            Painel do colaborador · {company.name}
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <CardAcao
          ...
          description="Registre rapidamente uma venda em dinheiro, PIX ou cartão."
