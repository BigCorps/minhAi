...
export default function ScenePublicar() {
  ...
  const recalc = useCallback(() => {
    ...
    const s = Math.min((cw - 24) / BASE_W, (ch - 24) / BASE_H)
    setScale(s < 1 ? s : 1)
  }, [])
