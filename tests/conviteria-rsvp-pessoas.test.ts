...
assert.deepEqual(normalizarPessoasRsvp([{ nome: 'Sofia', tipo: 'crianca', idade: null }], { exigirIdadeCrianca: false }).pessoas[0], { nome: 'Sofia', tipo: 'crianca', idade: null });
...
console.log('12/12 testes RSVP pessoas passaram.');
