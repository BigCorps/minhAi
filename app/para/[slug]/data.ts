...

{
  ...
  casos: [
    ...
    { titulo: 'Escola de idiomas', descricao: 'No vencimento da mensalidade, o assistente gera o link PIX por comando de voz e envia pelo WhatsApp — confirmação automática quando o aluno paga.' },
  ...
  faq: [
    ...
    { q: 'Preciso contratar um desenvolvedor para integrar isso?', a: 'Não. Com uma API de pagamentos tradicional, você precisaria programar a geração da imagem do QR Code, montar um servidor para receber webhooks de confirmação e estruturar o payload da transação manualmente. No minhAi, isso já vem pronto: você fala o valor e o assistente cuida do resto.' },
  ],
...

{
  ...
  subtitulo: 'Gere links de pagamento PIX personalizados por comando de voz, compartilhe pelo WhatsApp e receba na hora. Sem maquininha, com comissão simples sobre o valor recebido.',
  ...
  faq: [
    { q: 'Tem taxa por transação?', a: 'Sim, uma comissão sobre o valor recebido: 1% no minhAi Smart e 10% no minhAi Vendas (gratuito, sem mensalidade nem créditos). O valor já cai na sua chave PIX cadastrada com a comissão descontada.' },
    ...
    { q: 'Por que não usar uma API de pagamentos por conta própria?', a: 'Uma API exige que você programe a imagem do QR Code (a maioria só devolve o texto copia-e-cola), monte um endpoint próprio para escutar notificações de pagamento e envie metadados do cliente e do pedido em cada chamada. No minhAi, tudo isso já está pronto — você só fala o valor.' },
  ],
