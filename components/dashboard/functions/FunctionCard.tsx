  ...
  return (
    <div
      className={`border rounded-2xl p-6 transition-all ${
        isEnabled
          ? 'border-green-300 dark:border-green-800 bg-green-50 dark:bg-green-900/10 shadow-lg'
    ...
    >
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3 flex-1">
          <div 
            ...
            style={{ backgroundColor: `${fn.color || '#6366f1'}20` }}
          >
            <div 
              className="w-8 h-8 rounded-lg"
              style={{ backgroundColor: fn.color || '#6366f1' }}
            />
          </div>
      ...
      {isEnabled && stats.usageCount > 0 && (
        <div className="grid grid-cols-2 gap-3 pt-4 border-t border-gray-200 dark:border-white/10 mb-4">
      ...
      {fn.example_phrases && fn.example_phrases.length > 0 && (
        <div className="mt-4 p-3 bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-white/10">
