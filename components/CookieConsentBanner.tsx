...
export default function CookieConsentBanner() {
  ...
  return (
    <div
      ...
      className="fixed bottom-4 left-4 right-4 sm:right-auto sm:max-w-sm z-[60] rounded-2xl border border-white/10 bg-slate-900/95 backdrop-blur-xl shadow-2xl p-4 sm:p-5"
    >
      <p className="text-xs sm:text-sm text-white/80 leading-relaxed mb-3">
        ...
        Saiba mais no nosso{' '}
        <a href="/aviso" className="text-blue-400 font-semibold hover:underline">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex-1 px-4 py-2 rounded-full border border-white/20 text-white/70 text-xs sm:text-sm font-bold leading-none hover:bg-white/5 hover:text-white transition-all duration-300 active:scale-95"
        >
          Recusar
        </button>
      </div>
