...
// Painel direito inferior do Modo Venda
// Lista itens, controles de qty, totais e botão finalizar
  ...
  return (
    <div className={`flex flex-col h-full rounded-2xl border overflow-hidden ${
      ...
      <div className="flex-1 overflow-y-auto px-3 py-2 space-y-2 min-h-0">
        {itens.map((item) => (
          <div key={item.produto.id} className={`flex items-center gap-2 py-1 ${
            isDark ? '' : ''
          }`}>
            {/* Nome */}
            ...
            {/* Subtotal */}
            <span className={`text-xs font-bold min-w-[52px] text-right ${
