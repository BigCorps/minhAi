        ...
        <div className={`rounded-2xl shadow-xl p-6 md:p-8 transition-colors ${
          ...
          <div className="h-[70vh] overflow-y-auto pr-4">
            <div className={`prose max-w-none transition-colors ${
              ...
              <p>Bem-vindo ao ArteFinal.app. Ao utilizar nossos serviços, você concorda com estes Termos de Uso. Leia-os atentamente.</p>

              <h2>1. Aceitação dos Termos</h2>
              <p>Ao acessar e usar o ArteFinal.app, você aceita e concorda em cumprir estes Termos de Uso e todas as leis e regulamentos aplicáveis. Se você não concordar com algum destes termos, está proibido de usar ou acessar este serviço.</p>

              <h2>2. Descrição do Serviço</h2>
              <p>O ArteFinal.app é uma plataforma que utiliza ferramentas digitais, incluindo recursos de inteligência artificial, para auxiliar no preparo de arquivos gráficos para impressão.</p>
              <p>Nossos serviços incluem:</p>
              <ul>
                <li>Upload, ajuste e conversão de arquivos de imagem e arte</li>
                <li>Montagem de folhas de recorte e duplicação de imagens para produção gráfica</li>
                <li>Ferramentas de preparação de arquivos no padrão CMYK para impressão</li>
                <li>Funcionalidades auxiliadas por inteligência artificial para sugestão e seleção de funções dentro da plataforma</li>
              </ul>

              <h2>3. Conta de Usuário</h2>
              <p>Para utilizar o ArteFinal.app, você deve criar uma conta fornecendo informações precisas e completas, diretamente ou através de login com Google ou Facebook. Você é responsável por manter a confidencialidade de sua senha e por todas as atividades que ocorram em sua conta.</p>

              <h2>4. Login com Google e Facebook</h2>
              <p>Ao optar por fazer login com sua conta Google ou Facebook, você nos autoriza a acessar apenas as informações básicas de identificação (nome, email e foto de perfil) necessárias para criar e autenticar sua conta. Não acessamos outros dados dessas contas.</p>

              <h2>5. Arquivos e Conteúdo Enviado</h2>
              <ul>
                <li>Você é responsável pelo conteúdo dos arquivos, imagens e artes que enviar para a plataforma</li>
                <li>Você declara possuir os direitos necessários sobre o conteúdo enviado para processamento e impressão</li>
                <li>O ArteFinal.app não se responsabiliza pelo uso indevido de conteúdo protegido por direitos de terceiros enviado por você</li>
                <li>Os arquivos são processados para gerar o resultado solicitado (ex: ajuste de sangria, corte, duplicação) e armazenados apenas pelo tempo necessário para a prestação do serviço</li>
              </ul>

              <h2>6. Funcionalidades de Inteligência Artificial</h2>
              <p>Algumas funcionalidades podem ser auxiliadas por modelos de inteligência artificial de terceiros. Ao utilizar essas funcionalidades, você reconhece que:</p>
              <ul>
                <li>As sugestões e resultados gerados por IA podem conter imprecisões</li>
                <li>É sua responsabilidade revisar o resultado final antes de utilizá-lo para impressão</li>
                <li>O ArteFinal.app não se responsabiliza por resultados gerados automaticamente que não atendam às suas expectativas</li>
              </ul>

              <h2>7. Conduta do Usuário</h2>
              <p>Ao usar o ArteFinal.app, você concorda em NÃO:</p>
              <ul>
                <li>Usar o serviço para atividades ilegais ou não autorizadas</li>
                <li>Enviar arquivos que violem direitos de propriedade intelectual de terceiros</li>
              ...
              <p>Todo o conteúdo, recursos e funcionalidades do ArteFinal.app são de propriedade exclusiva da plataforma e estão protegidos por leis de propriedade intelectual. Você não pode copiar, modificar, distribuir ou reproduzir qualquer parte do serviço sem autorização prévia. Esta cláusula não se aplica ao conteúdo dos arquivos que você mesmo envia, cuja titularidade permanece sua.</p>

              <h2>9. Limitação de Responsabilidade</h2>
              <p>O ArteFinal.app é fornecido "como está" e "conforme disponível". Não garantimos que o serviço será ininterrupto, seguro ou livre de erros.</p>
              <p><strong>O ArteFinal.app não se responsabiliza por:</strong></p>
              <ul>
                <li>Perda de dados ou interrupções no serviço</li>
                <li>Danos diretos ou indiretos resultantes do uso da plataforma</li>
                <li>Erros de impressão decorrentes de arquivos enviados incorretamente pelo usuário</li>
