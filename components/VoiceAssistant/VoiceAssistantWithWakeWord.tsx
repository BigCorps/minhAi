...
case 'meu_sistema':
  ...
  playText('E A I, sou um funcionário de I Á inteligente. Escaneie o QR Code para saber mais sobre como meu sistema funciona e suas funcionalidades.').catch(err => {
