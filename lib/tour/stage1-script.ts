...
export const STAGE1_SCRIPT: SceneScript[] = [
  ...
  },
  {
    ...
    label: 'Instagram',
    audioText:
      'No seu Instagram e Facebook, respondendo mensagens diretas, comentários e enviando Dê M automaticamente, com as mesmas funcionalidades do Whatsapp, convertendo seguidores em clientes.',
    displayText:
  ...
  },
  {
    ...
    label: 'MCP',
    audioText:
      'Via protocolo MCP, integrado diretamente ao Claude, ChatGPT, Cursor e Manus, onde você pode pedir tarefas para a minha I Á diretamente pelo seu app de I Á favorito.',
    displayText:
  ...
  },
  {
    ...
    label: 'WhatsApp MCP',
    audioText:
      'E também pode pedir tarefas diretamente para o WhatsApp minha I Á, consultas, ações e integrações sem sair do aplicativo.',
    displayText:
  ...
  },
  {
    ...
    label: 'Conclusão',
    audioText:
      'Resumindo, sou multifuncional e multicanal, para quem precisa de um funcionário, assistente pessoal ou um aplicativo de I Á próprio, tudo com a mesma praticidade, inteligência, com configuração simples e rápida, sem precisar de conhecimento sobre programação. Venha me testar gratuitamente!',
     displayText:
