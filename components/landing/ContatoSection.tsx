  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-2xl w-full">
        ...
        {/* Cards de contato */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 w-full max-w-lg sm:max-w-2xl mb-10 sm:mb-12">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`group flex sm:flex-col items-center sm:justify-center gap-3 sm:gap-3 px-4 py-3.5 sm:py-6 rounded-xl border transition-all duration-300 hover:scale-[1.02] ${
              isDark
          ...
          >
            ...
            <div className="sm:text-center">
              <p className={`text-xs font-medium mb-0.5 ${isDark ? 'text-white/40' : 'text-gray-400'}`}>Site</p>
              <p className={`text-sm font-semibold ${isDark ? 'text-white' : 'text-gray-900'}`}>bigcorps.com.br</p>
            </div>
          </a>

          {/* WhatsApp */}
          <a
            href="https://wa.me/5511987311525"
            target="_blank"
            rel="noopener noreferrer"
            className={`group flex sm:flex-col items-center sm:justify-center gap-3 sm:gap-3 px-4 py-3.5 sm:py-6 rounded-xl border transition-all duration-300 hover:scale-[1.02] ${
              isDark
          ...
          >
            ...
            <div className="sm:text-center">
              <p className={`text-xs font-medium mb-0.5 ${isDark ? 'text-white/40' : 'text-gray-400'}`}>WhatsApp</p>
              <p className={`text-sm font-semibold ${isDark ? 'text-white' : 'text-gray-900'}`}>(11) 98731-1525</p>
            </div>
          </a>
          ...
          >
            ...
            <div className="sm:text-center">
              <p className={`text-xs font-medium mb-0.5 ${isDark ? 'text-white/40' : 'text-gray-400'}`}>Instagram</p>
              <p className={`text-sm font-semibold ${isDark ? 'text-white' : 'text-gray-900'}`}>@bigcorps</p>
            </div>
          </a>
        </div>
