...
// ── SAÍDA DA LANDING = CARREGAMENTO COMPLETO ────────────────────────────────
// A landing é a única tela da MelhorIA onde o Microsoft Clarity grava a
// sessão. Se a navegação para o login fosse do lado do cliente (router.push),
// o script continuaria vivo dentro do aplicativo e passaria a gravar telas com
// nome de medicamento e dosagem.
//
// Retirar o consentimento no ClarityInit ajuda, mas não é garantia dura. Um
// carregamento completo destrói a página e o script junto — é o único jeito de
// ter certeza. O custo é meio segundo a mais numa transição que acontece uma
// vez por usuário.
