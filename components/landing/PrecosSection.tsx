...
export default function PrecosSection({ theme = 'dark' }: PrecosProps) {
  ...
  return (
    ...
    >
      ...
      */}
      <div
        className="relative z-10 flex flex-col items-center w-full px-4 sm:px-6 lg:px-10
                   py-3 sm:py-4
      ...
      >
        ...
        {loading ? (
          ...
          <div className="w-full max-w-5xl flex flex-col gap-3 sm:gap-4 flex-shrink-0">
