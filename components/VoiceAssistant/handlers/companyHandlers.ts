...
export async function handleWifiQRCode({ companyId, setIsProcessing, setActiveModal, playText }: CompanyHandlerDeps) {

export async function handleCardapio({ companyId, setIsProcessing, setActiveModal, playText }: CompanyHandlerDeps) {

export async function handleNossoQRCode({ companyId, setIsProcessing, setActiveModal, playText }: CompanyHandlerDeps) {
