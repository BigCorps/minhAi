...
// PÁGINA DO DASHBOARD - Usa tema do contexto
  ...
  useEffect(() => {
    async function loadData() {
      ...
      if (currentUser) {
        // Load stats
        try {
          const [companiesRes, conversationsRes, faqsRes] = await Promise.all([
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="h-40 bg-slate-800/50 rounded animate-pulse" />
          <div className="h-40 bg-slate-800/50 rounded animate-pulse" />
          <div className="h-40 bg-slate-800/50 rounded animate-pulse" />
        </div>
      </div>
            ...
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                ...
                <p className={`text-sm ${theme === 'dark' ? 'text-white/40' : 'text-gray-500'}`}>
                  {stats.totalCompanies} assistentes
                </p>
              </div>
            </div>
