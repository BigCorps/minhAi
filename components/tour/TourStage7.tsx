'use client'
// components/tour/TourStage7.tsx

import { useState, useEffect, useRef, useCallback } from 'react'
import { STAGE7_SCRIPT, Stage7SceneId } from '@/lib/tour/stage7-script'
...
import SceneFuncoesIntro from './scenes/SceneFuncoesIntro'
import SceneFuncoesConhecimento from './scenes/SceneFuncoesConhecimento'
import SceneFuncoesComercial from './scenes/SceneFuncoesComercial'
import SceneFuncoesAgenda from './scenes/SceneFuncoesAgenda'
import SceneFuncoesContato from './scenes/SceneFuncoesContato'
import SceneFuncoesArquivos from './scenes/SceneFuncoesArquivos'
import SceneFuncoesMidia from './scenes/SceneFuncoesMidia'
import SceneFuncoesLocalizacao from './scenes/SceneFuncoesLocalizacao'
import SceneFuncoesConclusao from './scenes/SceneFuncoesConclusao'
...
export default function TourStage7({
  initialTheme = 'dark',
  onClose,
  onComplete,
  managerDelay = 2000,
  ...
  const currentScene = STAGE7_SCRIPT[sceneIndex]
  ...
  const runScene = useCallback(async (index: number) => {
    ...
    const scene = STAGE7_SCRIPT[index]
  ...
  const handleNext = useCallback(() => {
    const isLast = sceneIndex === STAGE7_SCRIPT.length - 1
...
function SceneRenderer7({ id, isSpeaking, theme }: { id: Stage7SceneId; isSpeaking: boolean; theme: 'dark' | 'light' }) {
  switch (id) {
    case 'funcoes-intro':        return <SceneFuncoesIntro />
    case 'funcoes-conhecimento': return <SceneFuncoesConhecimento />
    case 'funcoes-comercial':    return <SceneFuncoesComercial />
    case 'funcoes-agenda':       return <SceneFuncoesAgenda />
    case 'funcoes-contato':      return <SceneFuncoesContato />
    case 'funcoes-arquivos':     return <SceneFuncoesArquivos />
    case 'funcoes-midia':        return <SceneFuncoesMidia />
    case 'funcoes-localizacao':  return <SceneFuncoesLocalizacao />
    case 'funcoes-conclusao':    return <SceneFuncoesConclusao />
    default:                     return null
  }
}
